...
$query = 'SELECT * FROM mods WHERE mods.id = :modId';
...
<header class="full-width-grid-con">
    ...
    <section id="form-con" class="grid-con">
        <div id="mod-form" class="edit-form col-span-full">
            <h3>Mod Form</h3>
            <form action="edit-mod.php" class="admin-form" method="POST" enctype="multipart/form-data">
                <input name="pk" type="hidden" value="<?php echo $row['id']; ?>">
                <label class="admin-label" for="name">Name:</label>
                <input class="admin-input" name="name" type="text" value="<?php echo $row['name']; ?>" required><br><br>
                <label class="admin-label" for="handle">Handle:</label>
                <input class="admin-input" name="handle" type="text" value="<?php echo $row['handle']; ?>" required><br><br>
                <label class="admin-label" for="pic">Image:</label>
                <input class="admin-input" name="pic" type="text" value="<?php echo $row['pic']; ?>" required><br><br>
                <label class="admin-label" for="position">Position:</label>
                <input class="admin-input" name="position" type="text" value="<?php echo $row['position']; ?>" required><br><br>
                <label class="admin-label" for="mod_date">Mod Since:</label>
                <input class="admin-input" name="mod_date" type="text" value="<?php echo $row['mod_date']; ?>" required><br><br>
                <label class="admin-label" for="bio">Bio:</label>
                <textarea class="admin-input" name="bio" type="text" required><?php echo $row['bio']; ?></textarea><br><br>
                <label class="admin-label" for="pronouns">Pronouns:</label>
                <input class="admin-input" name="pronouns" type="text" value="<?php echo $row['pronouns']; ?>" required><br><br>
                <label class="admin-label" for="character_stan">Character Stan:</label>
                <input class="admin-input" name="character_stan" type="text" value="<?php echo $row['character_stan']; ?>" required><br>

                <input class="admin-input" name="submit" type="submit" value="Edit">
            </form>
        </div>
    </section>
