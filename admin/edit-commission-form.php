...
$query = 'SELECT * FROM commissions WHERE commissions.id = :commissionId';
...
<header class="full-width-grid-con">
    ...
    <section id="form-con" class="grid-con">
        <div id="commission-form" class="edit-form col-span-full">
            <h3>Commission Form</h3>
            <form action="edit-commission.php" class="admin-form" method="POST" enctype="multipart/form-data">
                ...
                <input class="admin-input" name="link" type="text" value="<?php echo $row['link']; ?>"><br>
