...
$query = 'SELECT * FROM artist_continents WHERE artist_continents.id = :artconId';
...
<header class="full-width-grid-con">
    ...
    <section id="form-con" class="grid-con">
        <div id="artist-continents-form" class="edit-form col-span-full">
            <h3>Artist - Continent Form</h3>
            <form action="edit-artist-continent.php" class="admin-form" method="POST" enctype="multipart/form-data">
                <input name="pk" type="hidden" value="<?php echo $row['id']; ?>">
                <label class="admin-label" for="artist">Artist ID:</label>
                <input class="admin-input" name="artist" type="number" min="1" required value="<?php echo $row['artist']; ?>"><br><br>
                <label class="admin-label" for="continent">Continent:</label>
                <input class="admin-input" name="continent" type="number" min="1" required value="<?php echo $row['continent']; ?>"><br>
