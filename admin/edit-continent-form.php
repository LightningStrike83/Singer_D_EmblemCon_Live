...
$query = 'SELECT * FROM continents WHERE continents.id = :continentId';
...
<header class="full-width-grid-con">
    ...
    <section id="form-con" class="grid-con">
        <div id="continents-form" class="edit-form col-span-full">
            <h3>Continent Form</h3>
            <form action="edit-continent.php" class="admin-form" method="POST" enctype="multipart/form-data">
                <input name="pk" type="hidden" value="<?php echo $row['id']; ?>">
                <label class="admin-label" for="continent">Continent:</label>
                <input class="admin-input" name="continent" type="text" value="<?php echo $row['continent']; ?>" required><br><br>
