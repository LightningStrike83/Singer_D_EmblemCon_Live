...
<header class="full-width-grid-con">
    ...
    <section id="form-con" class="grid-con">
        <div id="users-form" class="edit-form col-span-full">
            <h3>User Form</h3>
            <form action="edit-user.php" class="admin-form" method="POST" enctype="multipart/form-data">
                <input name="pk" type="hidden" value="<?php echo $row['id']; ?>">
                <label class="admin-label" for="username">Username:</label>
                <input class="admin-input" name="username" type="text" value="<?php echo $row['username']; ?>" required><br><br>
                <label class="admin-label" for="password">Password:</label>
                <input class="admin-input" name="password" type="text" value="<?php echo $row['password']; ?>" required><br>
