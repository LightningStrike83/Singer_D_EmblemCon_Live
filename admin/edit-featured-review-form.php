...
$query = 'SELECT * FROM featured_reviews WHERE featured_reviews.id = :reviewId';
...
<header class="full-width-grid-con">
    ...
    <section id="form-con" class="grid-con">
        <div id="exhibitor-form" class="edit-form col-span-full">
            <h3>Exhibitor Form</h3>
            <form action="edit-exhibitor.php" class="admin-form" method="POST" enctype="multipart/form-data">
                ...
                <label class="admin-label" for="review">Link:</label>
                <textarea class="admin-input" name="review" type="text" value="<?php echo $row['review']; ?>" required></textarea><br>
