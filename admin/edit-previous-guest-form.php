...
$query = 'SELECT * FROM previous_guests WHERE previous_guests.id = :prevGuestId';
...
<header class="full-width-grid-con">
    ...
    <section id="form-con" class="grid-con">
        <div id="previous-guest-form" class="edit-form col-span-full">
            <h3>Previous Guest Form</h3>
            <form action="edit-previous-guest.php" class="admin-form" method="POST" enctype="multipart/form-data">
