...
$query = 'SELECT * FROM panels WHERE panels.id = :panelId';
...
<header class="full-width-grid-con">
    ...
    <section id="form-con" class="grid-con">
        <div id="panel-form" class="edit-form col-span-full">
            <h3>Panel Form</h3>
            <form action="edit-panel.php" class="admin-form" method="POST" enctype="multipart/form-data">
                <input name="pk" type="hidden" value="<?php echo $row['id']; ?>">
                <label class="admin-label" for="title">Title:</label>
                <input class="admin-input" name="title" type="text" value="<?php echo $row['title']; ?>" required><br><br>
                <label class="admin-label" for="host">Host:</label>
                <input class="admin-input" name="host" type="text" value="<?php echo $row['host']; ?>" required><br><br>
                <label class="admin-label" for="day">Day:</label>
                <input class="admin-input" name="day" type="number" min="1" max="7" value="<?php echo $row['day']; ?>" required><br><br>
                <label class="admin-label" for="time">Time:</label>
                <input class="admin-input" name="time" type="text" value="<?php echo $row['time']; ?>" required><br><br>
                <label class="admin-label" for="year">Year:</label>
                <input class="admin-input" name="year" type="number" value="<?php echo $row['year']; ?>" required><br><br>
                <label class="admin-label" for="description">Description:</label>
                <textarea class="admin-input" name="description" type="text" required><?php echo $row['description']; ?></textarea><br>
