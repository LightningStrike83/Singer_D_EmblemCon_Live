...
$query = 'SELECT * FROM comics WHERE comics.id = :comicId';
    ...
    <section id="form-con" class="grid-con">
        <div id="comics-form" class="edit-form col-span-full">
            ...
            <form action="edit-comics.php" class="admin-form" method="POST" enctype="multipart/form-data">
                ...
                <input class="admin-input" name="number" type="number" min="1" value="<?php echo $row['number']; ?>" required><br><br>
                <label class="admin-label" for="image">Comic Image:</label>
                <input class="admin-input" name="image" type="text" value="<?php echo $row['image']; ?>" required><br>
