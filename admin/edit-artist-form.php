...
$query = 'SELECT * FROM artists WHERE artists.id = :artistId';
...
<header class="full-width-grid-con">
    ...
    <section id="form-con" class="grid-con">
        <div id="artist-form" class="edit-form col-span-full">
            <h3>Artist Form</h3>
            <form action="edit-artist.php" class="admin-form" method="POST" enctype="multipart/form-data">
                <input name="pk" type="hidden" value="<?php echo $row['id']; ?>">
                <label class="admin-label" for="name">Name:</label>
                <input class="admin-input" name="name" type="text" required value="<?php echo $row['name']; ?>"><br><br>
                <label class="admin-label" for="link">Link:</label>
                <input class="admin-input" name="link" type="text" value="<?php echo $row['link']; ?>"><br><br>
                <label class="admin-label" for="aa_table">AA Table:</label>
                <input class="admin-input" name="aa_table" type="text" required value="<?php echo $row['aa_table']; ?>"><br>
