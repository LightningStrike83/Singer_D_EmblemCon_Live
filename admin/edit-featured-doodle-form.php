...
$query = 'SELECT * FROM featured_doodles WHERE featured_doodles.id = :doodleId';
...
<header class="full-width-grid-con">
    ...
    <section id="form-con" class="grid-con">
        <div id="comics-form" class="edit-form col-span-full">
            <h3>Comic Form</h3>
            <form action="edit-comics.php" class="admin-form" method="POST" enctype="multipart/form-data">
                <input name="pk" type="hidden" value="<?php echo $row['id']; ?>">
                <label class="admin-label" for="title">Name:</label>
                <input class="admin-input" name="title" type="text" value="<?php echo $row['name']; ?>" required><br><br>
                <label class="admin-label" for="image_path">Doodle:</label>
                <input class="admin-input" name="image_path" type="text" value="<?php echo $row['image_path']; ?>" required><br>
