...
<header class="full-width-grid-con">
    ...
    <section id="form-con" class="grid-con">
        <div id="update-form" class="edit-form col-span-full">
            <h3>Update Form</h3>
            <form action="edit-update.php" class="admin-form" method="POST" enctype="multipart/form-data">
                <input name="pk" type="hidden" value="<?php echo $row['id']; ?>">
                <label class="admin-label" for="image_path">Image:</label>
                <input class="admin-input" name="image_path" type="text" value="<?php echo $row['image_path']; ?>" required><br><br>
                ...
                <textarea class="admin-input" name="body" type="text" required><?php echo $row['body']; ?></textarea><br><br>
                <label class="admin-label" for="link">Link:</label>
                <input class="admin-input" name="link" type="text" value="<?php echo $row['link']; ?>"><br><br>
                <label class="admin-label" for="date">Date:</label>
                <input class="admin-input" name="date" type="text" value="<?php echo $row['date']; ?>" required><br>
