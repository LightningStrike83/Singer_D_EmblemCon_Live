...
$query = 'SELECT * FROM guests WHERE guests.id = :guestId';
...
<header class="full-width-grid-con">
    ...
    <section id="form-con" class="grid-con">
        <div id="guest-form" class="edit-form col-span-full">
            <h3>Guest Form</h3>
            <form action="edit-guest.php" class="admin-form" method="POST" enctype="multipart/form-data">
                ...
                <input class="admin-input" name="social_media" type="text" value="<?php echo $row['social_media']; ?>" required><br><br>
