...
<body data-page="add-form">
    <header class="full-width-grid-con">
        ...
        <div class="m-col-span-1 sm-icons-header">
            <a target="_blank" href="https://t.co/J5iWSBYduP" class= "sm-icon">
                <svg class="" viewBox="0 -28.5 256 256" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid">
                    <g>
            ...
            <a target="_blank" href="https://www.instagram.com/theemblemcon/" class= "sm-icon">
        ...
        <div class="col-span-full header-links">
            ...
            <div class="sub-links-events">
                ...
                <a class="header-link" href="../announcements.html">ANNOUCEMENTS</a>
                <a class="header-link" href="../off-season.html">OFF-SEASON EVENTS</a>
            </div>

            <div class="sub-links-guests">
                <a class="header-link" href="../voice-actors.html">VOICE ACTORS & GUESTS</a>
                <a class="header-link" href="../artist-exhibitor.html">ARTISTS & EXHIBITORS</a>
            </div>
            ...
            <div class="sub-links-about">
                ...
                <a class="header-link" href="https://docs.google.com/document/d/1_cDZk7ylTlnkT4UQgRJ-2_Y89slCWmm9SofVBeFB0Uw/edit?usp=sharing">FAQ</a>
            </div>
        </div>
    </header>
    ...
    <section id="admin-con" class="grid-con">
        <div id="info-display-con" class="col-span-full">
            <select id="info-selection">
                ...
                <option value="commission">Commissioners</option>
    ...
    <section id="form-con" class="grid-con">
        ...
        <div id="artist-form" class="new-form col-span-full">
            ...
            <form action="add-artist.php" class="admin-form" method="POST" enctype="multipart/form-data">
                ...
                <input class="admin-input" name="link" type="text" required><br>
        ...
        <div id="update-form" class="new-form col-span-full">
            ...
            <form action="add-update.php" class="admin-form" method="POST" enctype="multipart/form-data">
                ...
                <label class="admin-label" for="link">Link:</label>
                <input class="admin-input" name="link" type="text" required><br><br>
