...
<head>
    ...
    <script defer type="module" src="../js/main.js?version=1.0"></script>
    ...
    <section id="admin-con" class="grid-con">
        <div id="info-display-con" class="col-span-full">
            <select id="info-selection">
                ...
                <option value="doodles">Submitted Doodles</option>
                <option value="reviews">Submitted Reviews</option>
                <option value="users">Users</option>
            </select>
        </div>

        <div id="add-button-con" class="col-span-full">
            <a href="add-new.php">Add A New Entry</a>
        </div>
        <div id="list-con" class="col-span-full"></div>
    </section>
